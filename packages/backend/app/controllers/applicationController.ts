...
class ApplicationController {
    public static async createApplication(req: any, res: any): Promise<any> {
        try {
            ...
            const templateDir = process.env.TEMPLATE_DIR || path.resolve(__dirname, '../../../../template');
            const usersApplicationDir = process.env.USERS_APPLICATION_DIR || path.resolve(__dirname, '../../../../user-applications');
